<template>
<div class="flex flex-col bg-gray-200 shadow-xl rounded hover:bg-blue-100 items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    ...
    <div role="alert" v-if="userService.state.error != userService.state.username">
      ...
      <div>
        <button type="submit"
         class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white  transition duration-500 ease-in-out bg-green-600 hover:bg-green-700 transform hover:-translate-y-1 hover:scale-110 ... focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
